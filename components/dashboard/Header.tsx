      ...
      <div className="flex items-center justify-between h-16 px-4 lg:px-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden sm:flex items-center">
            <Link href="/coming-soon" className="relative block">
              ...
              <div className="w-64 pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-sm text-gray-400 cursor-pointer hover:border-ge-green dark:hover:border-ge-gold transition-colors">
                {t('header.search')}
              </div>
            </Link>
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/coming-soon" className="relative p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <span className="absolute top-1 right-1 w-2 h-2 bg-ge-gold rounded-full" />
          </Link>
