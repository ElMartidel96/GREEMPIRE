...
const stories = [
  {
    ...
    image: null,
    initials: 'RM',
    quote: 'Empecé con mi carro personal hace 2 años. Hoy tengo 8 vehículos y un equipo de 12 conductores. Green Empire me dio las herramientas y el soporte para crecer.',
    stats: {
      before: '$800/semana',
      after: '$12,000/mes',
      time: '18 meses',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Link
            ...
            className="px-4 py-2 bg-ge-gold text-white rounded-lg font-medium hover:bg-ge-gold-light transition-colors flex items-center gap-2"
          >
            Únete Ahora
      ...
      <section className="relative py-16 px-4 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-ge-green/5 to-ge-gold/5 dark:from-ge-green/20 dark:to-ge-gold/20" />
        <div className="container mx-auto max-w-6xl relative">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-ge-gold mb-6 transition-colors"
          >
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-ge-green-light/10 text-ge-green-light rounded-full text-sm font-medium mb-6">
              <Award className="w-4 h-4" />
              Historias Reales de Éxito
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
              De Conductores a<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-ge-gold to-ge-green-light">
                Dueños de Negocios
              </span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Conoce a las personas que transformaron su futuro con Green Empire LLC.
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {milestones.map((milestone, index) => (
              ...
              >
                <milestone.icon className="w-8 h-8 mx-auto mb-3 text-ge-gold" />
              ...
              >
                <div className="md:flex">
                  ...
                  <div className="md:w-2/3 p-8">
                    <Quote className="w-10 h-10 text-ge-gold/30 mb-4" />
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div className="text-center p-4 bg-ge-green-light/10 rounded-xl">
                        <p className="text-xs text-ge-green-light uppercase mb-1">Después</p>
                        <p className="font-bold text-ge-green-light text-lg">{story.stats.after}</p>
                      </div>
                      <div className="text-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="bg-gradient-to-r from-ge-green to-ge-green-light rounded-2xl p-8 md:p-12 text-center text-white">
            <Leaf className="w-16 h-16 mx-auto mb-6 text-ge-gold" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/register?role=driver"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-ge-gold text-white rounded-xl font-semibold hover:bg-ge-gold-light transition-colors"
              >
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-6 text-sm text-gray-400">
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-ge-green-light" />
