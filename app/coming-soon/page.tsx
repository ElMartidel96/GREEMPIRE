...
import { Leaf, Mail, ArrowLeft, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        {/* Icon */}
        <div className="mb-6">
          <div className="w-24 h-24 mx-auto bg-ge-gold/10 dark:bg-ge-gold/20 rounded-full flex items-center justify-center">
            <Leaf className="w-12 h-12 text-ge-gold" />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 mb-8">
          <div className="flex items-center justify-center gap-3 mb-3">
            <div className="w-2 h-2 bg-ge-gold rounded-full animate-pulse" />
            <span className="font-medium text-gray-700 dark:text-gray-300">Trabajando en ello</span>
            <div className="w-2 h-2 bg-ge-gold rounded-full animate-pulse" style={{ animationDelay: '0.5s' }} />
          </div>
          <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
            <div className="bg-gradient-to-r from-ge-green to-ge-gold h-2 rounded-full w-2/3 animate-pulse" />
          </div>
        </div>
        ...
        <div className="bg-white/50 dark:bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-gray-200 dark:border-white/20 mb-8">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-ge-green dark:text-ge-gold font-medium hover:underline"
          >
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-ge-green dark:bg-ge-gold text-white rounded-lg font-medium hover:bg-ge-green-light dark:hover:bg-ge-gold-light transition-colors"
          >
