...
const levels = [
  ...
  },
  {
    ...
    color: 'from-ge-gold to-yellow-500',
  },
];
...
export default function DriverGuidePage() {
  return (
    <div className="space-y-8 max-w-4xl pb-12">
      ...
      {/* Hero Banner */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-ge-green via-ge-green-light to-ge-green-light p-8 text-white">
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-4">
            <Award className="w-8 h-8 text-ge-gold" />
            <span className="text-ge-gold font-semibold">PROGRAMA DE ÉXITO</span>
          </div>
        ...
        <div className="absolute -right-20 -bottom-20 w-80 h-80 bg-ge-gold/20 rounded-full blur-3xl" />
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 text-center border border-gray-100 dark:border-gray-700">
          <Package className="w-8 h-8 text-ge-green dark:text-blue-400 mx-auto mb-2" />
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 text-center border border-gray-100 dark:border-gray-700">
          <Clock className="w-8 h-8 text-ge-gold mx-auto mb-2" />
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
        <div className="p-6 border-b border-gray-100 dark:border-gray-700">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <Rocket className="w-6 h-6 text-ge-gold" />
            ...
            {successSteps.map((step, index) => (
              <div key={index} className="flex gap-4">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-ge-green to-ge-green-light flex items-center justify-center text-white font-bold">
                    {index + 1}
                  </div>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                    <step.icon className="w-4 h-4 text-ge-gold" />
                    {step.title}
                  </h3>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
        <div className="p-6 border-b border-gray-100 dark:border-gray-700">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <DollarSign className="w-6 h-6 text-ge-green-light" />
        ...
        <div className="p-6 grid md:grid-cols-2 gap-4">
          {earningsTips.map((tip, index) => (
            <div
              key={index}
              className="p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 hover:border-ge-gold transition-colors"
            >
              <div className="flex items-start justify-between mb-3">
                <div className="p-2 bg-ge-gold/10 rounded-lg">
                  <tip.icon className="w-5 h-5 text-ge-gold" />
                </div>
                <span className="text-lg font-bold text-ge-green-light">{tip.highlight}</span>
              </div>
                ...
                <ul className="space-y-1.5">
                  {level.benefits.map((benefit, i) => (
                    <li key={i} className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400">
                      <CheckCircle className="w-3 h-3 text-ge-green-light flex-shrink-0" />
                      {benefit}
                    </li>
                  ))}
                </ul>
      ...
      {/* Pro Tips */}
      <div className="bg-gradient-to-br from-ge-green to-ge-green-light rounded-xl p-6 text-white">
        <h2 className="text-xl font-bold mb-6 flex items-center gap-2">
          <Star className="w-6 h-6 text-ge-gold" />
          Tips de Conductores Élite
        </h2>
        <div className="grid md:grid-cols-2 gap-4">
          {proTips.map((tip, index) => (
            <div key={index} className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <h3 className="font-semibold text-ge-gold mb-1">{tip.title}</h3>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex items-start gap-3">
            <Phone className="w-5 h-5 text-ge-green-light flex-shrink-0 mt-0.5" />
            <div>
      ...
      {/* CTA */}
      <div className="bg-gradient-to-r from-ge-gold to-ge-green-light rounded-xl p-8 text-center text-white">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-8 py-3 bg-white text-ge-green rounded-lg font-semibold hover:bg-gray-100 transition-colors"
        >
          Ver Mis Entregas
