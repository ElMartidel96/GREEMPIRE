...
const sections = [
  {
    ...
    content: `En Green Empire Lawn & Landscape, creemos que el éxito se construye sobre la confianza mutua.
    ...
    <div className="space-y-6 max-w-4xl pb-12">
      ...
      <div className="bg-gradient-to-r from-ge-green to-ge-green-light rounded-xl p-6 text-white">
        <div className="flex items-start gap-4">
          <Scale className="w-10 h-10 text-ge-gold flex-shrink-0" />
          <div>
        ...
        <div className="flex flex-wrap gap-2">
          {sections.map((section) => (
            <a
              key={section.id}
              href={`#${section.id}`}
              className="px-3 py-1.5 text-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-ge-gold/20 hover:text-ge-gold transition-colors"
            >
              {section.title}
            </a>
          ))}
        ...
        {sections.map((section) => (
          ...
          >
            <div className="p-6 border-b border-gray-100 dark:border-gray-700 flex items-center gap-3">
              <div className="p-2 bg-ge-green/10 dark:bg-ge-green/30 rounded-lg">
                <section.icon className="w-6 h-6 text-ge-green dark:text-ge-gold" />
              </div>
      ...
      {/* Agreement Section */}
      <div className="bg-ge-green-light/10 dark:bg-ge-green-light/20 rounded-xl p-6 border border-ge-green-light/30">
        <div className="flex items-start gap-4">
          <CheckCircle className="w-8 h-8 text-ge-green-light flex-shrink-0" />
          <div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        <div className="flex items-start gap-4">
          <AlertCircle className="w-8 h-8 text-ge-gold flex-shrink-0" />
          <div>
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">
              ¿Tienes Preguntas?
            </h3>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-ge-green dark:bg-ge-gold text-white rounded-lg text-sm font-medium hover:bg-ge-green-light dark:hover:bg-ge-gold-light transition-colors"
            >
      ...
      <div className="text-center py-6">
        <div className="inline-flex items-center gap-3 px-6 py-3 bg-gray-100 dark:bg-gray-700 rounded-full">
          <Shield className="w-5 h-5 text-ge-green-light" />
          <span className="text-sm text-gray-600 dark:text-gray-400">
            Comprometidos con la transparencia y tu éxito
          </span>
          <Star className="w-5 h-5 text-ge-gold" />
        </div>
      </div>
    </div>
  );
