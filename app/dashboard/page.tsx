          ...
          <div className="p-6 border-b border-gray-100 dark:border-gray-700">
            <div className="flex items-center justify-between">
              ...
              <a
                ...
                className="text-sm text-ge-green dark:text-ge-gold hover:underline font-medium"
              >
          ...
          <div className="p-6 space-y-3">
              ...
              <>
                ...
                >
                  <div className="p-2 bg-ge-green/10 dark:bg-ge-green/30 rounded-lg">
                    <Package className="w-5 h-5 text-ge-green dark:text-ge-gold" />
                  </div>
                  <div>
                ...
                <a
                  ...
                  className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                >
                  <div className="p-2 bg-ge-green-light/10 dark:bg-ge-green-light/30 rounded-lg">
                    <Users className="w-5 h-5 text-ge-green-light" />
                  </div>
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white">
                ...
                <a
                  ...
                  className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                >
                  <div className="p-2 bg-ge-gold/10 dark:bg-ge-gold/30 rounded-lg">
            ...
            {role === 'driver' && (
              <>
                ...
                >
                  <div className="p-2 bg-ge-green-light/10 dark:bg-ge-green-light/30 rounded-lg">
                    <DollarSign className="w-5 h-5 text-ge-green-light" />
                  </div>
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white">
