    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                Nunca Caminas<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-ge-gold">
                  Solo en Este Camino
                </span>
              </h1>
            ...
            <div className="relative">
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-ge-gold rounded-full flex items-center justify-center">
                ...
                <ul className="space-y-3">
                  {['Mentor con experiencia comprobada', 'Sesiones semanales de seguimiento', 'Plan de desarrollo personalizado', 'Acceso a comunidad exclusiva'].map((item, i) => (
                    <li key={i} className="flex items-center gap-3 text-gray-600 dark:text-gray-400">
                      <CheckCircle className="w-5 h-5 text-ge-green-light flex-shrink-0" />
                      {item}
                    </li>
                  ))}
                </ul>
                  ...
                  <ul className="space-y-2">
                    {phase.topics.map((topic, i) => (
                      <li key={i} className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                        <div className="w-1.5 h-1.5 rounded-full bg-ge-gold" />
                        {topic}
                      </li>
                    ))}
                  </ul>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <Lightbulb className="w-16 h-16 mx-auto mb-6 text-ge-gold" />
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
          ...
          <Link
            href="/register?role=driver"
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-600 to-ge-gold text-white rounded-xl font-semibold text-lg hover:from-purple-700 hover:to-ge-gold-light transition-colors"
          >
