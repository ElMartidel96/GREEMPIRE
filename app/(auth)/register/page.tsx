      ...
      <div className="min-h-screen theme-gradient-bg flex items-center justify-center p-4">
        ...
        <div className="w-full max-w-md relative z-10">
          <div className="glass-crystal rounded-2xl p-8 text-center">
            ...
            <Link
              href="/login"
              className="inline-block w-full py-3 bg-gradient-to-r from-ge-green to-ge-green-light text-white rounded-lg font-semibold hover:from-ge-green-light hover:to-ge-green transition-all"
            >
              Ir a Iniciar Sesión
            </Link>
            ...
            <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">
              ...
              <button
                ...
                className="text-ge-green dark:text-ge-gold hover:underline"
              >
                Intenta de nuevo
              </button>
            </p>
  ...
  return (
    <div className="min-h-screen theme-gradient-bg flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 opacity-30 dark:opacity-20 pointer-events-none overflow-hidden">
        <div className="absolute top-20 right-10 w-72 h-72 bg-ge-green/40 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl animate-pulse" />
        <div className="absolute bottom-20 left-10 w-72 h-72 bg-ge-green/30 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-xl animate-pulse" />
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="glass-crystal rounded-2xl p-8 max-h-[90vh] overflow-y-auto">
          ...
          {/* Driver badge */}
          {isDriverSignup && (
            <div className="mb-4 p-3 bg-ge-gold/10 border border-ge-gold/30 rounded-lg flex items-center gap-3">
              <Leaf className="w-5 h-5 text-ge-gold" />
              <p className="text-sm font-medium text-ge-gold">{t('register.driverSignup')}</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2">
              <input
                type="checkbox"
                required
                className="mt-1 w-4 h-4 rounded border-gray-300 text-ge-green focus:ring-ge-green"
              />
              <p className="text-xs text-gray-600 dark:text-gray-400">
                {t('register.terms')}{' '}
                <Link href="/terms" className="text-ge-green dark:text-ge-gold hover:underline">
                  {t('register.termsLink')}
                </Link>{' '}
                {t('register.and')}{' '}
                <Link href="/privacy" className="text-ge-green dark:text-ge-gold hover:underline">
          ...
          <p className="text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link href="/login" className="text-ge-green dark:text-ge-gold font-semibold hover:underline">
