  ...
  return (
    <div className="min-h-screen theme-gradient-bg flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 opacity-[0.06] dark:opacity-[0.03] pointer-events-none overflow-hidden">
        <div className="absolute -top-10 -right-10 w-[400px] h-[400px] bg-ge-green-light rounded-full filter blur-3xl" />
        <div className="absolute -bottom-10 -left-10 w-[400px] h-[400px] bg-ge-gold rounded-full filter blur-3xl" />
      </div>
