      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
            <div className="w-20 h-20 bg-ge-green-light/20 rounded-full flex items-center justify-center mx-auto mb-6">
              <CheckCircle className="w-10 h-10 text-ge-green-light" />
            </div>
            ...
            <div className="space-y-3">
              <Link
                href="/"
                className="block w-full py-3 bg-ge-green dark:bg-ge-gold text-white rounded-lg font-semibold hover:bg-ge-green-light dark:hover:bg-ge-gold-light transition-colors"
              >
                {t.backToHome}
              </Link>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="tel:+19547954030" className="hidden sm:flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-ge-gold transition-colors">
              <Phone className="w-4 h-4" />
              <span className="text-sm">(954) 795-4030</span>
            </a>
            <Link
              href="/register?role=driver"
              className="px-4 py-2 text-sm font-medium text-ge-green dark:text-ge-gold hover:underline"
            >
              {t.individualDriver}
            </Link>
          </div>
      ...
      <section className="relative py-16 px-4 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-ge-green/10 to-ge-gold/10 dark:from-ge-green/20 dark:to-ge-gold/20" />
        <div className="container mx-auto max-w-6xl relative">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-ge-gold/10 text-ge-gold rounded-full text-sm font-medium mb-6">
              <Building2 className="w-4 h-4" />
              {t.dspProgram}
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
              {t.heroTitle1}<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-ge-green to-ge-gold">
                {t.heroTitle2}
              </span>
            </h1>
          ...
          <div className="grid grid-cols-3 gap-4 mb-12">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 text-center shadow-sm border border-gray-200 dark:border-gray-700">
              <DollarSign className="w-8 h-8 text-ge-green-light mx-auto mb-2" />
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 text-center shadow-sm border border-gray-200 dark:border-gray-700">
              <Leaf className="w-8 h-8 text-ge-green dark:text-blue-400 mx-auto mb-2" />
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
                <TrendingUp className="w-6 h-6 text-ge-gold" />
                {t.benefitsTitle}
              </h2>
                ...
                {t.benefits.map((benefit, index) => {
                  ...
                  return (
                    <div key={index} className="flex gap-4">
                      <div className="flex-shrink-0 w-12 h-12 bg-ge-green/10 dark:bg-ge-green/30 rounded-xl flex items-center justify-center">
                        <Icon className="w-6 h-6 text-ge-green dark:text-ge-gold" />
                      </div>
                      <div>
                ...
                {t.levels.map((level, index) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <p className="font-bold text-ge-green-light">{level.commission}</p>
            ...
            <div className="bg-gradient-to-br from-ge-green to-ge-green-light rounded-2xl p-6 text-white">
              <h2 className="text-xl font-bold mb-4 flex items-center gap-2">
                <FileText className="w-6 h-6 text-ge-gold" />
                {t.requirementsTitle}
              </h2>
              <ul className="space-y-3">
                {t.requirements.map((req, index) => (
                  <li key={index} className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-ge-green-light flex-shrink-0 mt-0.5" />
          ...
          <div>
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700 sticky top-24">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-ge-gold text-gray-900 dark:text-white"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-ge-gold text-gray-900 dark:text-white appearance-none"
                      >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-ge-gold text-gray-900 dark:text-white"
                  ...
                  <div className="col-span-2">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-ge-gold text-gray-900 dark:text-white resize-none"
                ...
                <button
                  type="submit"
                  className="w-full py-3 bg-gradient-to-r from-ge-gold to-ge-green text-white rounded-lg font-semibold hover:from-ge-green hover:to-ge-gold transition-all flex items-center justify-center gap-2"
                >
                  {t.submitButton}
      ...
      {/* Footer CTA */}
      <section className="bg-ge-green py-12 px-4">
        <div className="container mx-auto max-w-4xl text-center text-white">
          <Clock className="w-12 h-12 mx-auto mb-4 text-ge-gold" />
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-3 bg-ge-gold text-white rounded-lg font-semibold hover:bg-ge-gold-light transition-colors"
          >
